...
            <th><strong>Telefonos</strong></th>
			...
			<th><strong>Cod. de  Rutina</strong></th>
...
  	<?php
			if(!empty($_POST['numero'])){
					...
					foreach ($objHoja as $iIndice=>$objCelda) {
						...
						$name=$objCelda['A'];						$lastname=$objCelda['B'];
						$email=$objCelda['C'];						$dni=$objCelda['D'];
						$city=$objCelda['E'];						$active=$objCelda['F'];	
                                                $address=$objCelda['G'];	
						$dateborn=date('Y-m-d');
						$c_empleado = new Proceso_Empleado($name, $lastname, $email,$dni, $dateborn, '', $city,$active, $address, '$idFkLogin','$idFkRole', '');
						$c_empleado->crear();
